...
export namespace TrailerEventTypeCategory {
  export function isTrailerEventCategory(value: any): value is TrailerEventTypeCategory {
    if (!value) {
      return false;
    }
  ...
  export function toReadableName(category: TrailerEventTypeCategory = TrailerEventTypeCategory.unknown) {
    switch (category) {
  ...
  export function toReadableInfo(category: TrailerEventTypeCategory = TrailerEventTypeCategory.unknown) {
    switch (category) {
      case TrailerEventTypeCategory.loading:
