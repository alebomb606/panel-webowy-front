...
export namespace MonitoringCameras {
  ...
  export function emptyImage(trailerId: TrailerId, type: MonitoringCameras, time: string): MonitoringCamera {
    return { id: '', type, mediaType: 'image', eventDate: time, trailerId, alarm: false, isLoading: false };
  }
}
