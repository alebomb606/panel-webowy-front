...
export default function PersonCheck({ date, logistician, type }: PersonCheckProps) {
  ...
  let info = type ? `${t(TrailerStates.toReadableName(type))}, ` : '';
  info += logistician ? `${logistician.first_name} ${logistician.last_name}` : '';
