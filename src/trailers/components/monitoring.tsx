...
import Pickers from '../../monitoring/components/pickers';
import { selectCamera, selectTime } from '../../monitoring/actions';
...
export default function Monitoring({
  ...
  const datetime = moment(currentTime)
    .startOf('minute')
    .toDate();
